export const MODE_META = {
  ...
  prepare: { label: "Prepare for approval", short: "Prepare", desc: "Prepares drafts; you confirm before anything runs.", chip: "bg-violet-500/15 text-violet-300 border-violet-500/30" },
...
export const KIND_META = {
  ...
  generative: { label: "AI draft", chip: "bg-violet-500/15 text-violet-300 border-violet-500/30" },
