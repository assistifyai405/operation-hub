...
function GlobalSearch({ navigate }) {
  ...
  return (
    <div className="relative w-full sm:w-80" data-testid="dashboard-search">
      ...
      <label htmlFor="dashboard-search-input" className="sr-only">Search workspace</label>
      <input
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <motion.h1 initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="text-2xl font-bold tracking-tight text-zinc-50 sm:text-3xl" data-testid="dashboard-greeting">
            {workspaceEmpty ? "Welcome" : hero.greeting}{firstName ? `, ${firstName}` : ""}
          </motion.h1>
          {!workspaceEmpty && (
          ...
          {workspaceEmpty && (
            <p className="mt-1.5 text-sm text-zinc-500">Your AI-powered business operating system is ready — start with one useful action.</p>
          )}
        </div>
