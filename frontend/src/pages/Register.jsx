...
export default function Register() {
  ...
  return (
    <AuthShell
      ...
      subtitle="Start running your business in minutes."
      footer={
        <p className="mt-6 text-center text-xs text-zinc-500">
          Already have an account?{" "}
          <Link to="/login" className="text-violet-400 hover:text-violet-300" data-testid="go-login-link">Sign in</Link>
        </p>
      }
    >
      <form onSubmit={handleSubmit} className="mt-8 space-y-4" data-testid="register-form">
        ...
        <div>
          ...
          <input type="email" value={form.email} onChange={set("email")} required data-testid="register-email" className={inputClass} placeholder="you@company.com" />
        </div>
        <div>
